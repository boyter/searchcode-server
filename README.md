...
* You can either
    ...
    * Copy the following files searchcode-1.3.13.jar searchcode-server.bar and searchcode-server.sh to your instance directory
...
After the following date 01 February 2021 the software version '1.3.13' is dual licenced under the Fair Source Licence included in the LICENSE.txt file or under the GNU General Public License Version 3 with terms specified at https://www.gnu.org/licenses/gpl-3.0.txt
