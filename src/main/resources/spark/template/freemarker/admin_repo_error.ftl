...
<@layout.masterTemplate title="Repository Error">
    ...
    <div class="row inside-container">
        ...
        <div class="col-md-10">
            <h3 style="border-bottom: 1px solid #eee; padding-bottom: 14px; margin-top:0px;">Repository Error
                - ${repoResult.name}</h3>
            <p>There was an issue with indexing the repository "${repoResult.name}". Details of the repository are
                included below.</p>
            ...
            <dl class="dl-horizontal">
                ...
                <dd>The URL provided is incorrect or you have selected the wrong SCM. Check that you are able to clone
                    or checkout a copy using the provided details above. To remedy you will need to delete the
                    repository and add it again.
                </dd>
                <dt>not authorized</dt>
                <dd>The username or password provided is incorrect or is required in order to check out this repository.
                    To resolve this you will need to delete the repository and add it again with correct details.
                </dd>
            </dl>
