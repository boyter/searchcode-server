...
public class SearchcodeLibTest extends TestCase {
    ...
    public void testGenerateBusBlurb() {
        ...
        String busBlurb = scl.generateBusBlurb(new ProjectStats(10, 1, codeFacetLanguages, null, codeFacetOwners, null));
    ...
    public void testGenerateBusBlurbMore() {
        ...
        String busBlurb = scl.generateBusBlurb(new ProjectStats(10, 10, codeFacetLanguages, null, codeFacetOwners, null));
    ...
    public void testGenerateBusBlurbStress() {
        ...
        for (int i=0; i < 1000; i++) {
            ...
            scl.generateBusBlurb(new ProjectStats(i, i, codeFacetLanguages, null, codeFacetOwners, null));
        }
    }
